...
// If a product is selected, fetch its details via POST
$selected = isset($_POST['product']) ? $_POST['product'] : null;
$details = null;
...
<div class="layout">
    <div class="nav_toc">
        ...
        <?php else: ?>
            ...
            ?>
                <form method="POST">
                    <input type="hidden" name="product" value="<?= e($name) ?>">
                    <button type="submit" class="<?= $isActive ? 'active' : '' ?> cursor-hover" style="background:none;border:none;">
                        <?= e($name) ?>
                    </button>
                </form>
                <br>
